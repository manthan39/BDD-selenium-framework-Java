...
from ui.test.test_registrationpage import registrationTestPage
# -*- coding: utf-8 -*-
import os
import StringIO
...
class Test_HTMLTestRunner(unittest.TestCase):
    ...
    def test_main(self):
        ...
        self.suite = unittest.TestSuite()
        self.suite.addTests([
            unittest.defaultTestLoader.loadTestsFromTestCase(registrationTestPage)
            ])
        ...
        runner = HTMLTestRunner.HTMLTestRunner(
                    stream=outfile,
                    title='<Python selenium framework>',
                    description='created by Manthan Bhatiya.'
                    )
        runner.run(self.suite)
